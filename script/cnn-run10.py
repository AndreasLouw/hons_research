...
def main():
    ...
    def val_transforms(example_batch):
        ...
        example_batch["pixel_values"] = [_val_transforms(
            pil_img.convert("RGB")) for pil_img in example_batch["image"]]
        return example_batch
...
if __name__ == "__main__":
    with open("error.txt", "w") as file1:
        try:
            wandb.login(key="b34cc213e4c93e65ac1f6fa8ec6f0ace37249584")
            wandb.init(
                project="colabCnnMnistRun10"
            )
            main()
